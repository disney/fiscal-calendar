...
do ->
	{ FiscalYear } = await import('../dist/index.js')
	...
	test 'holidays array', (t) =>
		yearHolidays =
			'2020': ['2019-11-28', '2019-11-29', '2019-12-25', '2020-01-01', '2020-01-20', '2020-02-17', '2020-05-25', '2020-07-03', '2020-09-07']
			'2024': ['2023-11-23', '2023-11-24', '2023-12-25', '2024-01-01', '2024-01-15', '2024-02-19', '2024-05-27', '2024-06-19', '2024-07-04', '2024-09-02']
			'2025': ['2024-11-28', '2024-11-29', '2024-12-25', '2025-01-01', '2025-01-20', '2025-02-17', '2025-05-26', '2025-06-19', '2025-07-04', '2025-09-01']
